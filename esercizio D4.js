...
//  me.skills.pop()   //elimina l'ultimo array
//  console.log(me);
/* ESERCIZIO 2
 ...
 */
  ...
  // for (let i = 0; i < arrayNormale.length; i++) {
  //   if (arrayNormale[i] % 2 === 0) {
  //     arrayPari.push(arrayNormale[i])
  //   }
  // }
...
*/
// let es11 = [20,35,9,10,88,1]
// let max = es11[0]
// for (let i = 0; i < es11.length; i++) {
//   if (es11[i] > max ) {
//     max = es11[i]
//   }
// }
...
// for (let i = 0; i < movies.length; i++) {
//   sommaYear = sommaYear + parseInt(movies[i].Year)
// }
